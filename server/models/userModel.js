...
User.prototype.deletePic = function (callback){
	console.log(this.data);
	db.query(`DELETE FROM pictures WHERE id = '${this.data.pic_id}')`, function (err, results) {
		if (err){
			throw err;
			callback(err, null);
		}
...
User.prototype.savePic = function (callback){
	console.log(this.data);
...
User.prototype.getProfilePic = function (callback){
    console.log(this.data);
...
User.prototype.getPicById = function (callback){
    console.log(this.data);
...
User.prototype.setProfilePic = function (callback){
	db.query(`UPDATE TABLE pictures SET profile_pic = '0' WHERE user = '${this.data.user_name}' AND profile_pic = '1'`),
